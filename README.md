...
کتابخانه `tweepy` را هم برای پایتون ۳ یا با باز کردن پروژه در پای چارم و مراجعه به بخش تنظیمات، از طریق علامت مثبتی که هنگام انتخاب شماره نسخه پایتون ظاهر می شود نصب کنید و یا با دستور زیر در خط فرمان ویندوز آنرا نصب کنید : 
